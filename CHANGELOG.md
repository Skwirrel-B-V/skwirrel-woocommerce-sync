...
- feat: support full category tree sync from Skwirrel to WooCommerce (4cc4568)
- chore: release 1.2.0 [skip ci] (b53f504)
- Add purge functionality to delete Skwirrel products, categories, and attributes with background support. (9fdb592)
- chore: release 1.1.0 [skip ci] (99dc9b0)
- chore: release 1.0.2 [skip ci] (9f5c61a)
...
- chore: release 1.0.1 [skip ci] (be21660)
